...
Implementation Phase 1 is active. Sprint 1 focuses on repository setup, architecture skeleton, API foundation, data foundation, and QA/acceptance readiness.
...
- `/docs/api` — OpenAPI placeholder and API foundation notes
