...
| S2-07 | Scheduled worker, operational monitoring, staging demo and acceptance | SRE / QA / Product | Controlled in-process candidate job implemented; scheduler, monitoring, staging demo, S2-T13, rollback and sign-off remain |
