...
| S2-03 | Weather adapter, normalization and bounded failover | Data Engineer | Canonical normalizer and tenant-safe snapshot persistence started; vendor adapter, credentials/quotas/TTL and S2-T06–07 remain |
| S2-04 | Forward migrations and tenant-safe run persistence | Backend Lead | Migration 0002 and store primitive; point publication/job tests still pending |
