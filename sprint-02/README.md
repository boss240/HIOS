...
| S2-07 | Scheduled worker, operational monitoring, staging demo and acceptance | SRE / QA / Product | Controlled job plus UTC schedule/tenant-safe lease primitives implemented; worker, monitoring, staging demo, S2-T13, rollback and sign-off remain |
