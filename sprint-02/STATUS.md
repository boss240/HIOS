...
| S2-D08 | First wave of ten inverter-cloud providers: Deye, SolarEdge, SMA, Fronius, Huawei, GoodWe, Growatt, Sungrow, Solis and Victron | Data Ops/Product | Read-only adapter contract exists; complete supplier access, owner consent, field mapping and a tenant-safe pilot before ingesting data |
